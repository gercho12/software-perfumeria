        ...
        if (validPrices.length === 0) {
            ...
            if (data.items && data.items[0]?.link) {
                ...
                try {
                    ...
                    const scrapeResponse = await fetch('ec2-18-119-112-192.us-east-2.compute.amazonaws.com:3001/api/scrape-price', { // Asegúrate que la URL del backend sea correcta
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
